...
- [ ] 🛠️ 手部驱动问题 DexHand driver issue
- [ ] ✨ 新功能 / 新包请求 Feature request / new package

## 环境 / Environment

- 架构 Arch: [amd64 / arm64]
- 系统 OS: [RobopiOS 1.0.6 / RobopiOS 1.2.7 / Ubuntu 22.04 / Ubuntu 24.04]
- 包名和版本 Package & version: <!-- roboparty_dexhand 0.4.1 -->

## 现象 / What happened

<!-- 发生了什么？请附日志、CMake 输出、CAN 配置和硬件信息。 -->
<!-- What went wrong? Include logs, CMake output, CAN configuration, and hardware details. -->
